...
$$.CanvasRenderingContext2D = {"": "CanvasRenderingContext;",
  scale$2: function(receiver, sx, sy) {
    return receiver.scale($.numTypeCheck(sx), $.numTypeCheck(sy));
  },
...
$$.CssMatrix = {"": "Interceptor;",
  scale$3: function(receiver, scaleX, scaleY, scaleZ) {
    return receiver.scale($.numTypeCheck(scaleX), $.numTypeCheck(scaleY), $.numTypeCheck(scaleZ));
  },
  get$scale: function(_receiver) {
...
$$.Element = {"": "Node;",
  ...
  insertAdjacentText$2: function(receiver, where, text) {
    if (!!receiver.insertAdjacentText)
      ...
      this._insertAdjacentNode$2(receiver, where, $.HtmlDocument_methods.$$dom_createTextNode$1(document, text));
  },
...
$$.Touch = {"": "Interceptor;identifier=", $isTouch: true, $asTouch: null};
...
$$.FEDisplacementMapElement = {"": "StyledElement;scale=", $asObject: null};
...
$$.Matrix = {"": "Interceptor;",
  scale$1: function(receiver, scaleFactor) {
    return receiver.scale($.numTypeCheck(scaleFactor));
  },
  get$scale: function(_receiver) {
    return new $.Bound_scale_Matrix(this, "scale$1", _receiver);
  },
  $isMatrix: true,
  $asMatrix: null
};
...
$$.Bound_scale_Matrix4 = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$3: function(p0, p1, p2) {
    return this._self[this._liblib1$_target](this._receiver, p0, p1, p2);
  },
  call$1: function(x) {
...
$$.Bound_scale_Vector3 = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$1: function(p0) {
    return this._self[this._liblib1$_target](this._receiver, p0);
  },
  $is_FutureOnError: true,
...
$$.Bound_scale_Vector4 = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$1: function(p0) {
    return this._self[this._liblib1$_target](this._receiver, p0);
  },
  $is_FutureOnError: true,
...
$$.BoundClosure$i2 = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$2: function(p0, p1) {
    return this._self[this._liblib1$_target](this._receiver, p0, p1);
  }
};

$$.BoundClosure$i3 = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$3: function(p0, p1, p2) {
    return this._self[this._liblib1$_target](this._receiver, p0, p1, p2);
  }
};

$$.Bound_scale_Matrix = {"": "BoundClosure;_self,_liblib1$_target,_receiver",
  call$1: function(p0) {
    return this._self[this._liblib1$_target](this._receiver, p0);
  },
  $is_FutureOnError: true,
...
Point: {"": "Object;x,y",
  ...
  $add: function(_, other) {
    ...
    if (t1 == null)
      throw t1.$add();
    return new $.Point(t2, $.JSNumber_methods.$add(t1, t3));
  },
  $mul: function(_, factor) {
    var t1, t2;
    t1 = this.x;
...
GameLoopHtml: {"": "GameLoop;element,_frameCounter,_initialized,_interrupt,_previousFrameTime,_frameTime,_resizePending,_nextResize,maxAccumulatedTime,_accumulatedTime,_gameTime,_renderInterpolationFactor,resizeLimit,_pointerLock,_keyboard,_mouse,_gamepad0,_lastMousePos,_touchSet,_rafId,_touchEvents,_keyboardEvents,_mouseEvents,onRender,onResize,onFullscreenChange,onPointerLockChange,onTouchStart,onTouchEnd,updateTimeStep,lib6$GameLoop$maxAccumulatedTime,_timers,onUpdate",
  ...
  _touchStartEvent$1: function($event) {
    ...
    $.JSArray_methods.add$1(this._touchEvents, new $._GameLoopTouchEvent($event, 3));
  ...
  _touchMoveEvent$1: function($event) {
    $.interceptedTypeCheck($event, "$isTouchEvent");
    $.JSArray_methods.add$1(this._touchEvents, new $._GameLoopTouchEvent($event, 1));
    $event.preventDefault();
  },
  ...
  _touchEndEvent$1: function($event) {
    $.interceptedTypeCheck($event, "$isTouchEvent");
    $.JSArray_methods.add$1(this._touchEvents, new $._GameLoopTouchEvent($event, 2));
    $event.preventDefault();
  },
...
GameLoopTouchSet: {"": "Object;activeTouches<,gameLoop<",
  ...
  _verifyTouchList$1: function(touches) {
    ...
    if (t1.get$length(touches) !== t2._liblib0$_length)
      $.Primitives_printString($.S(t1.get$length(touches)) + " " + t2._liblib0$_length);
...
GameLoopTouchSet__start_closure: {"": "Closure;this_0",
  call$1: function(touch) {
    ...
    if (t2.$index(t2, touch.identifier) != null)
      return;
    t2 = t1.get$activeTouches();
    $.assertHelper(t2.$index(t2, touch.identifier) == null);
    t2 = t1.get$activeTouches();
...
GameLoopTouchSet__verifyTouchList_closure: {"": "Closure;this_0,touches_1",
  call$2: function(identifier, touch) {
    if (!this.this_0._inTouchList$2(this.touches_1, identifier))
      $.Primitives_printString("Did not find " + $.S(identifier));
  },
  $isFunction: true,
  $asObject: null,
  $isDigitalButtonEventInterceptor: true,
...
initShowPicking: function() {
  var control, showPickingCheck, t1, t2, t3, t4, t5, $arguments, arguments0, t6, label;
  control = $.interceptedTypeCheck($.HtmlDocument_methods.query$1(document, "#control"), "$isDivElement");
  $.assertHelper(control != null);
  showPickingCheck = $.interceptedTypeCheck($.InputElement_InputElement(null), "$isInputElement");
  showPickingCheck.type = "checkbox";
  showPickingCheck.id = "show_picking";
  showPickingCheck.checked = $.showPicking;
  showPickingCheck.get$onClick;
  t1 = $.assertSubtype($.EventStreamProvider_click.forTarget$1(showPickingCheck), "$isStream", [$.MouseEvent], "$asStream");
  t2 = new $.initShowPicking_closure(showPickingCheck);
  $.propertyTypeCheck(t2, "$isFunction");
  $.propertyTypeCheck(null, "$isFunction");
  $.propertyTypeCheck(null, "$isFunction");
  t3 = t1.get$_target();
  ...
  label = $.interceptedTypeCheck($.HtmlDocument_methods.$$dom_createElement$1(document, "label"), "$isLabelElement");
  label.htmlFor = showPickingCheck.id;
  label.appendText$1;
  $.insertAdjacentText$2$x(label, "beforeend", "show picking");
...
boot: function() {
  ...
  t1.width = 780;
  t1.height = 500;
  canvasbox = $.interceptedTypeCheck($.HtmlDocument_methods.query$1(document, "#canvasbox"), "$isDivElement");
...
initSkybox: function(gl) {
  ...
  skyboxModel = new $.SkyboxModel(null, null, null, 3, 2, $.interceptedTypeCheck(t3, "$isList"), $.interceptedTypeCheck(t1, "$isList"));
...
initAirshipTex: function(gl) {
  ...
  airshipModel = new $.TexModel(null, 2, t2, $.interceptedTypeCheck(t1, "$isMap"), null, null, 3, 2, $.interceptedTypeCheck(t3, "$isList"), $.interceptedTypeCheck(t4, "$isList"));
  ...
  airshipModel2 = new $.TexModel(null, 2, t3, $.interceptedTypeCheck(t4, "$isMap"), null, null, 3, 2, $.interceptedTypeCheck(t2, "$isList"), $.interceptedTypeCheck(t5, "$isList"));
  ...
  $.assertHelper(true);
  t5.$builtinTypeInfo = [$.Instance];
  colonyShipModel = new $.TexModel(null, 2, t3, $.interceptedTypeCheck(t4, "$isMap"), null, null, 3, 2, $.interceptedTypeCheck(t2, "$isList"), $.interceptedTypeCheck(t5, "$isList"));
  ...
  $.assertHelper(true);
  t5.$builtinTypeInfo = [$.Instance];
  coneModel = new $.TexModel(null, 2, t3, $.interceptedTypeCheck(t4, "$isMap"), null, null, 3, 2, $.interceptedTypeCheck(t2, "$isList"), $.interceptedTypeCheck(t5, "$isList"));
...
update: function(gl, gameLoop) {
  ...
  if (m.pressed$1(0)) {
    ...
    $.Primitives_printString("mouse hit: " + $.S($.mouseClickHit($.picker.instanceList, color)));
  }
  t1 = $.get$cam();
...
main: function() {
  ...
  gameLoop._pointerLock.lockOnClick = false;
  $.Primitives_printString("gameLoop lockOnClick = " + gameLoop._pointerLock.lockOnClick);
  ...
  gameLoop.onUpdate = $.propertyTypeCheck(new $.main_closure(gl), "$isGameLoopUpdateFunction");
...
PickerShader: {"": "ShaderProgram;u_Color,programList,instanceList<,framebuffer,offscreen,program,gl,a_Position,u_MV,u_P,shaderReady,modelList",
  _createRenderbuffer$3: function(gl, width, height) {
    ...
    try {
      $.texImage2D$9$x(gl, 3553, 0, 6408, width, height, 0, 6408, 5121, null);
    } catch (exception) {
      t1 = $.unwrapException(exception);
      e = t1;
      $.Primitives_printString("FIXME DEBUG work-around: PickerShader: gl.texImage2D: exception: " + $.S(e));
    }
  ...
  drawModels$3: function(gameLoop, cam, pMatrix) {
    ...
    t3 = new $.PickerShader_drawModels_closure(this, gameLoop, cam);
    $.propertyTypeCheck(t3, "$isFunction");
    $.voidTypeCheck($.IterableMixinWorkaround_forEach(this.instanceList, t3));
  ...
  PickerShader$4: function(gl, programList, width, height) {
    var t1, t2;
    t1 = this.programList;
    t2 = new $.PickerShader_closure(this);
    t1.forEach$1;
    $.propertyTypeCheck(t2, "$isFunction");
    $.voidTypeCheck($.IterableMixinWorkaround_forEach(t1, t2));
...
PickerShader_closure: {"": "Closure;this_0",
  call$1: function(p) {
    var t1, t2;
    t1 = p.get$modelList();
    t2 = new $.PickerShader__closure(this.this_0);
    $.propertyTypeCheck(t2, "$isFunction");
    $.voidTypeCheck($.IterableMixinWorkaround_forEach(t1, t2));
  },
  $isFunction: true,
...
PickerShader__closure: {"": "Closure;this_1",
  call$1: function(m) {
    var t1, t2, $arguments, arguments0;
    t1 = m.get$instanceList();
    t2 = new $.PickerShader___closure();
    $.propertyTypeCheck(t2, "$isFunction");
    $.propertyTypeCheck(t2, "$isFunction");
    t2 = new $.WhereIterable($.listSuperNativeTypeCheck(t1, "$isIterable"), t2);
    $.assertHelper(true);
    ...
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ...
      $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
    t1 = $arguments == null ? null : $arguments[0];
    $.forEach$1$ax($.listSuperNativeTypeCheck(t2, "$isIterable"), new $.PickerShader___closure0(this.this_1));
  },
  $isFunction: true,
  $asObject: null,
  $is_FutureOnError: true,
...
Model$fromJson: function(gl, URL) {
  ...
  t1 = new $.Model(null, null, 3, 2, $.interceptedTypeCheck(t1, "$isList"), $.interceptedTypeCheck(t2, "$isList"));
...
generatePickColor: function() {
  ...
  if (i === 3)
    $.Primitives_printString("generatePickColor: overflow");
  t1 = $.get$_currentPickColor();
  $.interceptedTypeCheck(t1, "$isList");
  $.interceptedTypeCheck(t1, "$isList");
  return new Float32Array(t1);
},
...
matchColor: function(i, f) {
  ...
  if (0 >= i.length)
    throw $.ioore(0);
  d0 = $.doubleTypeCheck(Math.abs(255 * t1 - i[0]));
  if (1 >= f.length)
    throw $.ioore(1);
  t1 = f[1];
  if (1 >= i.length)
    throw $.ioore(1);
  d1 = $.doubleTypeCheck(Math.abs(255 * t1 - i[1]));
  if (2 >= f.length)
    throw $.ioore(2);
  t1 = f[2];
  if (2 >= i.length)
    throw $.ioore(2);
  d2 = $.doubleTypeCheck(Math.abs(255 * t1 - i[2]));
  if (d0 == null)
    throw d0.$lt();
  if (d0 < 1) {
    if (d1 == null)
...
mouseClickHit: function(list, color) {
  var match, pi, t1, t2, $arguments, arguments0, exception;
  ...
  try {
    ...
    $.propertyTypeCheck(t2, "$isFunction");
    $.propertyTypeCheck(null, "$isFunction");
    t2 = $.IterableMixinWorkaround_firstWhere(t1, t2, null);
    $arguments = t1.$asJSArray;
    arguments0 = $.getRuntimeTypeInfo(t1);
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ;
    ...
    pi = $.propertyTypeCheck(t2, "$isInstance");
  } catch (exception) {
    $.unwrapException(exception);
    return;
  }
...
PickerShader$: function(gl, programList, width, height) {
  var t1, t2;
  t1 = $.List_List($, $.PickerInstance);
  $.assertHelper(true);
  t1.$builtinTypeInfo = [$.PickerInstance];
  t2 = $.List_List($, $.Model);
  $.assertHelper(true);
  t2.$builtinTypeInfo = [$.Model];
  t1 = new $.PickerShader(null, $.interceptedTypeCheck(programList, "$isList"), $.interceptedTypeCheck(t1, "$isList"), null, null, null, gl, null, null, null, false, $.interceptedTypeCheck(t2, "$isList"));
  t1.PickerShader$4(gl, programList, width, height);
  return t1;
}}],
["skybox", "skybox.dart", , {
...
Vector3: {"": "Object;storage",
  ...
  scale$1: function(_, arg) {
    ...
    if (2 >= t1.length)
      throw $.ioore(2);
    t2 = $.JSNumber_methods.$mul(t1[2], arg);
    if (2 >= t1.length)
      throw $.ioore(2);
    t1[2] = t2;
    t2 = $.JSNumber_methods.$mul(t1[1], arg);
    if (1 >= t1.length)
      throw $.ioore(1);
    t1[1] = t2;
    t2 = $.JSNumber_methods.$mul(t1[0], arg);
    if (0 >= t1.length)
      throw $.ioore(0);
    t1[0] = t2;
    return this;
  ...
  get$scale: function(_receiver) {
    return new $.Bound_scale_Vector3(this, "scale$1", _receiver);
  },
  $isVector3: true
},
...
Vector4: {"": "Object;storage",
  ...
  $add: function(_, other) {
    ...
    $.doubleTypeCheck(t7);
    $.doubleTypeCheck(t4);
    t1 = new $.Vector4(new Float32Array(4));
    t5 = t1.storage;
    if (3 >= t5.length)
      throw $.ioore(3);
    t5[3] = t4;
  ...
  scale$1: function(_, arg) {
    ...
    if (1 >= t3)
      throw $.ioore(1);
    t3 = $.JSNumber_methods.$mul(t1[1], arg);
    t2 = t1.length;
    if (1 >= t2)
      throw $.ioore(1);
    t1[1] = t3;
    ...
    if (3 >= t3)
      throw $.ioore(3);
    t3 = $.JSNumber_methods.$mul(t1[3], arg);
    if (3 >= t1.length)
      throw $.ioore(3);
    t1[3] = t3;
    return this;
  ...
  get$scale: function(_receiver) {
    return new $.Bound_scale_Vector4(this, "scale$1", _receiver);
  },
  get$w: function() {
    var t1 = this.storage;
    if (3 >= t1.length)
...
$.texImage2D$9$x = function(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8) {
  return $.getInterceptor$x(receiver).texImage2D$9(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8);
};
