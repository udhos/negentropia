...
class AxisInstance extends Instance {
  ...
  void draw(GameLoopHtml gameLoop, ShaderProgram prog, Camera cam) {
    ...
    p = model.pieceList[0];
    gl.drawElements(RenderingContext.LINES, p.vertexIndexLength, RenderingContext.UNSIGNED_SHORT,
...
class SolidShader extends ShaderProgram {
  ...
  SolidShader(RenderingContext gl, List<ShaderProgram> programList) : super(gl, "solidShader") {
